...
//                 logger.error(MyError.baseLog(__filename, this.findOne.name, e.errorCode.toString(), e.message));
//             }
//             throw e;
//         }
//     }
...
//                 logger.error(MyError.baseLog(__filename, this.findAll.name, e.code, e.message));
